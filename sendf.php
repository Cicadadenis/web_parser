...
<form method="post" id="s">    
    <select name="sel" class="form-control" id="exampleFormControlSelect1">
     ...
     $MadelineProto->echo('
	    ...
	    <textarea class="form-control" name="texts" id="exampleFormControlTextarea1" rows="3" >'.$_SESSION['text'].'</textarea>

	    <small id="emailHelp" class="form-text text-muted">Ваш текст </small>
