...
$fullInfoAboutChannel = $MadelineProto->getFullInfo("$nam");
$countParticipants = $fullInfoAboutChannel['full']['participants_count'];
$MadelineProto->echo("Всего подписчиков у канала: $countParticipants\n");
...
$participants = [];
    ...
    foreach ($getParticipants['participants'] as $participant) {
        ...
        if ($participant['user']['status']['_']==='userStatusRecently'){
$i++;
