                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">Парсер по коментариям</h4>
...
<form method="post" id="s">    
      <div class="form-group">
          ...
          <br> id канала.<br>t.me/joinchat/example<br>
		  </label><br><br>
    ...
    <input type="text" class="form-control"   name="pars" aria-describedby="emailHelp" placeholder="Ссылка на канал откуда собираем юзеров:">
        <input type="text" class="form-control"   name="co" aria-describedby="emailHelp" placeholder="Количество постов пройти">
        <input type="text" class="form-control"   name="li" aria-describedby="emailHelp" placeholder="Количество юзера с поста">

    <input type="text" class="form-control"   name="nam" aria-describedby="emailHelp" placeholder="Ведите имя файла">

  <a  id="go" class="btn btn-primary">Собрать</a>

  <a  style="display:none;" id="go2" class="btn btn-warning">Сбор выполняется</a>
