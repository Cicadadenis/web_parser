                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">Парсер гео кто онлайн</h4>
...
<div id="coordinates">
  Поставьте точку на карте,что бы получит координаты
</div>
...
$('#lats').val(myLatlng.lat);
$('#lngs').val(myLatlng.lng);
...
<form method="post" id="s">    
    ...
    <input type="text" class="form-control"   id="lats" name="lat" aria-describedby="emailHelp" value="">
    <input type="text" class="form-control"   id="lngs" name="lng" aria-describedby="emailHelp" value="">
