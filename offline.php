                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">Парсер Недавно онлайн</h4>
...
<form method="post" id="s">    
      <div class="form-group">
          ...
          <br> id канала.<br>t.me/joinchat/example</label><br><br>
          <p style="border: 1px solid red;padding: 5px;">Что бы собрать больше недавних юзеров необходимо,что бы вашу последнюю активность никто не видел.<br>
