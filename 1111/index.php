...
<html>
	<head>
		<title>FTP-Browser-Cicada3301 | Авторизоваться</title>
		<meta charset="UTF-8">
...
<div class="w3-padding w3-black w3-center">FTP-Browser created Cicada3301 <a href="https://github.com/Kelta-King/FTP-browser">FTP-Browser-Cicada3301</a></div>
<div class="w3-light-gray w3-container w3-center w3-padding-32" style="z-index:2;">
		...
		<div class="w3-xxlarge w3-bold w3-margin-top"><b>FTP-Browser-Cicada3301</b></div>
		...
		<form class="w3-container w3-center w3-margin" id="login">
			...
			<div class="w3-section">
				<button type="button" class="w3-black w3-round w3-padding w3-border-0 w3-black" onclick="login()" style="margin:0;width:20%;cursor:pointer">Авторизоваться</button>
			</div>
