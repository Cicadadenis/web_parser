...
<html>
	<head>
		<title>FTP-Browser-Cicada3301 | Browse files Cicada3301</title>
		<meta charset="UTF-8">
...
<div>
  <div class="w3-bar w3-padding w3-theme">
    <div class="w3-col s3">
      <a class="w3-padding w3-block w3-theme" style="text-align:left;cursor:context-menu">FTP-BROWSER-Cicada3301</a>
    </div>
    
    <div class="w3-col s1 w3-right">
      <a href="logout.php" class="w3-button w3-block w3-theme kel-hover-2 Logout" style="text-align:center">Выйти</a>
    </div>
  </div>
</div>
...
<nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width:250px;margin-top:53px" id="mySidebar">
  <div class = "w3-xxlarge w3-padding">
	<b>Только список корневых каталогов</b>
  </div>
...
<div class="w3-main" style="margin-left:250px;">
	...
	<button type="file" class="w3-bar-item w3-button w3-border w3-margin-right kel-hover-2" onclick="openUploadFile()"><i class="fa fa-upload w3-large"></i> Загрузить файл</button>
	<a class="w3-bar-item w3-button w3-border w3-margin-right kel-hover-2" onclick="openFolderModal()"><i class="fa fa-folder-open w3-large"></i> Новая папка</a>
	<a class="w3-bar-item w3-button w3-border w3-margin-right kel-hover-2" onclick="previousFolder()"><i class="fa fa-mail-reply w3-large"></i> Предыдущая папка</a>
	<a class="w3-bar-item w3-button w3-border w3-margin-right kel-hover-2" onclick="rootFolder()"><i class="fa fa-backward w3-large"></i> Корневая папка</a>
</div>
