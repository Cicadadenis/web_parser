...
//}
     ...
     <div id="onlines" style="display:show;"><form method="post" id="s">    
      <div class="form-group">
            <label for="offer">
    <p style="border: 1px solid red;padding: 5px;">Внимание выбирая количество постов. расценивайте возможности вашего сервера.<br>
       <br><br></p>
...
<input type="text" class="form-control"   name="co" aria-describedby="emailHelp" placeholder="Количество постов пропустить">
        <input type="text" class="form-control"   name="li" aria-describedby="emailHelp" placeholder="Количество юзеров">
